...
class DocumentController extends Controller
{
    ...
    {
        return $this->getDocumentsForIndex($request, 'tanda_terima', 'TandaTerima/Index', 'receipts');
    }

    public function tandaTerimaNew(Request $request)
    {
        return $this->getDocumentsForIndex($request, 'tanda_terima_new', 'TandaTerima/New', 'receipts');
    }

    public function scheduleTukarFaktur(Request $request)
    {
        return $this->getDocumentsForIndex($request, 'schedule_tukar_faktur', 'ScheduleTukarFaktur/Index', 'schedules');
    }

    public function suratTagihan(Request $request)
    {
        return $this->getDocumentsForIndex($request, 'surat_tagihan', 'SuratTagihan/Index', 'letters');
    }

    public function titipInternal(Request $request)
    {
        return $this->getDocumentsForIndex($request, 'titip_internal', 'TitipInternal/Index', 'items');
    }
