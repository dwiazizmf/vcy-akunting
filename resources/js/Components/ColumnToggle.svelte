...
<!-- ===== COLUMN PICKER OVERLAY (fixed position, tidak terclip overflow apapun) ===== -->
{#if isOpen}
  ...
  <!-- Panel kolom — fixed, tidak terpengaruh overflow parent -->
  <div class="fixed z-50 bg-white border border-slate-200 rounded-xl shadow-2xl p-3 w-56 max-h-[80vh] overflow-y-auto"
